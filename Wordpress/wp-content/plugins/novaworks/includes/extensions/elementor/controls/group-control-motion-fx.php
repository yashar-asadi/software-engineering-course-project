...
class Group_Control_Motion_Fx extends Group_Control_Base {
    ...
    protected function init_fields() {
        $fields = [
            'motion_fx_scrolling' => [
                'label' => __( 'Scrolling Effects', 'novaworks' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => __( 'Off', 'novaworks' ),
                'label_on' => __( 'On', 'novaworks' ),
                'render_type' => 'ui',
        ...
        $fields['transform_origin_x'] = [
            'label' => __( 'X Anchor Point', 'novaworks' ),
        ...
        $fields['transform_origin_y'] = [
            'label' => __( 'Y Anchor Point', 'novaworks' ),
            'type' => Controls_Manager::CHOOSE,
            'default' => 'center',
            'options' => [
                'top' => [
        ...
        $fields['devices'] = [
            'label' => __( 'Apply Effects On', 'novaworks' ),
        ...
        $fields['motion_fx_mouse'] = [
            'label' => __( 'Mouse Effects', 'novaworks' ),
            'type' => Controls_Manager::SWITCHER,
            'label_off' => __( 'Off', 'novaworks' ),
            'label_on' => __( 'On', 'novaworks' ),
            'separator' => 'before',
    ...
    private function get_scrolling_effects() {
        return [
            'translateY' => [
                'label' => __( 'Vertical Scroll', 'novaworks' ),
                'fields' => [
                    'direction' => [
                        'label' => __( 'Direction', 'novaworks' ),
                        'type' => Controls_Manager::SELECT,
                        'options' => [
                            '' => __( 'Up', 'novaworks' ),
                            'negative' => __( 'Down', 'novaworks' ),
                        ],
                    ],
                    'speed' => [
                        'label' => __( 'Speed', 'novaworks' ),
            ...
            'translateX' => [
                'label' => __( 'Horizontal Scroll', 'novaworks' ),
                'fields' => [
                    'direction' => [
                        'label' => __( 'Direction', 'novaworks' ),
                        'type' => Controls_Manager::SELECT,
                        'options' => [
                            '' => __( 'To Left', 'novaworks' ),
                            'negative' => __( 'To Right', 'novaworks' ),
                        ],
                    ],
                    'speed' => [
                        'label' => __( 'Speed', 'novaworks' ),
            ...
            'opacity' => [
                'label' => __( 'Transparency', 'novaworks' ),
                'fields' => [
                    'direction' => [
                        'label' => __( 'Direction', 'novaworks' ),
                        'type' => Controls_Manager::SELECT,
    ...
    private function get_mouse_effects() {
        return [
            'mouseTrack' => [
                'label' => __( 'Mouse Track', 'novaworks' ),
                'fields' => [
                    'direction' => [
                        'label' => __( 'Direction', 'novaworks' ),
                        'type' => Controls_Manager::SELECT,
                        'default' => '',
                        'options' => [
                            '' => __( 'Opposite', 'novaworks' ),
                            'negative' => __( 'Direct', 'novaworks' ),
                        ],
                    ],
                    'speed' => [
                        'label' => __( 'Speed', 'novaworks' ),
            ...
            'tilt' => [
                ...
                'fields' => [
                    'direction' => [
                        ...
                        'options' => [
                            '' => __( 'Direct', 'novaworks' ),
                            'negative' => __( 'Opposite', 'novaworks' ),
                        ],
                    ],
                    'speed' => [
                        'label' => __( 'Speed', 'novaworks' ),
