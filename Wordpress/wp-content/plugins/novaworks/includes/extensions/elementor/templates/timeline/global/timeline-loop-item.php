		...
		<div class="timeline-item__card-inner">
				<?php
					if ( 'yes' === $item_settings['show_item_image'] ) {
                        ...
                        echo sprintf('<div class="timeline-item__card-img"><img src="%s" alt=""></div>', apply_filters('novaworks_wp_get_attachment_image_url', $item_image) );
					}
				?>
