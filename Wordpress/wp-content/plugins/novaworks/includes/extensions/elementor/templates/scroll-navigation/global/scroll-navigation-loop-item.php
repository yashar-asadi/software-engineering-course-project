...
$hint_classes_array = array( 'novaworks-scroll-navigation__item-hint' );
...
?>
<div class="novaworks-scroll-navigation__item" <?php echo $section_id_attr; ?> <?php echo $section_invert; ?>>
	<div class="novaworks-scroll-navigation__dot"><?php
		echo $this->__loop_item( array( 'item_dot_icon' ), '<i class="%s"></i>' ); ?>
	</div>
	<div class="<?php echo $hint_classes; ?>"><?php
		echo $this->__loop_item( array( 'item_icon' ), '<span class="novaworks-scroll-navigation__icon"><i class="%s"></i></span>' );
		echo $this->__loop_item( array( 'item_label' ), '<span class="novaworks-scroll-navigation__label">%s</span>' );?>
	</div>
</div>
