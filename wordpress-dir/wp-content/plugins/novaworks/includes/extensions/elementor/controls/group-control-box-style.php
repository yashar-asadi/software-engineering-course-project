...
class Group_Control_Box_Style extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['box_font_color'] = array(
			'label'     => esc_html__( 'Font Color', 'novaworks' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
		...
		$fields['box_size'] = array(
			'label'      => esc_html__( 'Box Size', 'novaworks' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_height'] = array(
			'label'      => esc_html__( 'Box Height', 'novaworks' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em',
			),
		...
		$fields['box_border'] = array(
			'label'   => _x( 'Border Type', 'Border Control', 'novaworks' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				''       => __( 'None', 'novaworks' ),
				'solid'  => _x( 'Solid', 'Border Control', 'novaworks' ),
				'double' => _x( 'Double', 'Border Control', 'novaworks' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'novaworks' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'novaworks' ),
			),
			'selectors' => array(
		...
		$fields['box_border_width'] = array(
			'label'     => _x( 'Width', 'Border Control', 'novaworks' ),
		...
		$fields['box_border_color'] = array(
			'label' => _x( 'Color', 'Border Control', 'novaworks' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => array(
		...
		$fields['allow_box_shadow'] = array(
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'novaworks' ),
		...
		$fields['box_shadow_position'] = array(
			'label' => _x( 'Position', 'Box Shadow Control', 'novaworks' ),
			'type' => Controls_Manager::SELECT,
			'options' => array(
				' '     => _x( 'Outline', 'Box Shadow Control', 'novaworks' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'novaworks' ),
			),
			'condition' => array(
				'allow_box_shadow!' => '',
			),
