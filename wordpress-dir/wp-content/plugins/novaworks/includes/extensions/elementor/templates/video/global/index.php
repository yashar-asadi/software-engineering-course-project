...
$this->add_render_attribute( 'wrapper', 'class', 'novaworks-video' );
$this->add_render_attribute( 'wrapper', 'data-settings', esc_attr( json_encode( $data_settings ) ) );

if ( ! empty( $settings['aspect_ratio'] ) ) {
	$this->add_render_attribute( 'wrapper', 'class', 'novaworks-video-aspect-ratio' );
	$this->add_render_attribute( 'wrapper', 'class', 'novaworks-video-aspect-ratio--' . esc_attr( $settings['aspect_ratio'] ) );
}
?>
